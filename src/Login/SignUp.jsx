          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            <div className={styles.formdiv}>
              <div className={styles.mob}>
                <img style={{width: "30px", height: "30px"}} src="https://emojiguide.com/wp-content/uploads/platform/joypixels/43830.png" />
                <p style={{marginTop: "-0.1px", textAlign: "center"}}>+91</p>
              </div>
              <input
